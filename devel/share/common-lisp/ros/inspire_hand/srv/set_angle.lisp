...
(cl:defmethod cl:initialize-instance :after ((m <set_angle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_angle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name inspire_hand-srv:<set_angle-request> is deprecated: use inspire_hand-srv:set_angle-request instead.")))

(cl:ensure-generic-function 'angle0-val :lambda-list '(m))
(cl:defmethod angle0-val ((m <set_angle-request>))
...
(cl:defmethod angle1-val ((m <set_angle-request>))
...
(cl:defmethod angle2-val ((m <set_angle-request>))
...
(cl:defmethod angle3-val ((m <set_angle-request>))
...
(cl:defmethod angle4-val ((m <set_angle-request>))
...
(cl:defmethod angle5-val ((m <set_angle-request>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<set_angle-request>)))
  ...
  "b897f7828905e174d7da19d5b21c5ed3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'set_angle-request)))
  "Returns md5sum for a message object of type 'set_angle-request"
  "b897f7828905e174d7da19d5b21c5ed3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<set_angle-request>)))
  ...
  (cl:format cl:nil "int32 angle0~%int32 angle1~%int32 angle2~%int32 angle3~%int32 angle4~%int32 angle5~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'set_angle-request)))
  "Returns full string definition for message of type 'set_angle-request"
  (cl:format cl:nil "int32 angle0~%int32 angle1~%int32 angle2~%int32 angle3~%int32 angle4~%int32 angle5~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <set_angle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_angle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name inspire_hand-srv:<set_angle-response> is deprecated: use inspire_hand-srv:set_angle-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_angle-response>)))
  ...
  "inspire_hand/set_angleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_angle-response)))
  "Returns string type for a service object of type 'set_angle-response"
  "inspire_hand/set_angleResponse")
