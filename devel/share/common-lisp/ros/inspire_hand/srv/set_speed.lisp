...
(cl:defmethod cl:initialize-instance :after ((m <set_speed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_speed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name inspire_hand-srv:<set_speed-request> is deprecated: use inspire_hand-srv:set_speed-request instead.")))

(cl:ensure-generic-function 'speed0-val :lambda-list '(m))
(cl:defmethod speed0-val ((m <set_speed-request>))
...
(cl:defmethod speed1-val ((m <set_speed-request>))
...
(cl:defmethod speed2-val ((m <set_speed-request>))
...
(cl:defmethod speed3-val ((m <set_speed-request>))
...
(cl:defmethod speed4-val ((m <set_speed-request>))
...
(cl:defmethod speed5-val ((m <set_speed-request>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<set_speed-request>)))
  ...
  "9679dcfdc38eebef480b0c5f0f9a084d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'set_speed-request)))
  "Returns md5sum for a message object of type 'set_speed-request"
  "9679dcfdc38eebef480b0c5f0f9a084d")
...
(cl:defmethod cl:initialize-instance :after ((m <set_speed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_speed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name inspire_hand-srv:<set_speed-response> is deprecated: use inspire_hand-srv:set_speed-response instead.")))

(cl:ensure-generic-function 'speed_accepted-val :lambda-list '(m))
(cl:defmethod speed_accepted-val ((m <set_speed-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inspire_hand-srv:speed_accepted-val is deprecated.  Use inspire_hand-srv:speed_accepted instead.")
  (speed_accepted m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_speed-response>)))
  ...
  "inspire_hand/set_speedResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_speed-response)))
  "Returns string type for a service object of type 'set_speed-response"
  "inspire_hand/set_speedResponse")
